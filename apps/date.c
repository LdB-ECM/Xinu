...
static unsigned int date_time = 0;
...
char *weekday_names[7] = { "Sunday", "Monday", "Tuesday", "Wednesday",
    "Thursday", "Friday", "Saturday"
};

char *tz_names[24] = {            /* UTC */
    "", "", "", "", "", "",     /* UTC+5 */
    "", "", "", "", "", "",     /* UTC+11 */
    /* UTC-12 */
    "", "", "H", "AK", "P", "M",        /* UTC-7 */
 ...
 */
void convertDate(struct time *t, unsigned int seconds)
{
    int leapyear;
    int dst_day;
    int leapday = 0;
