...
static void telnetSendOption(device *, unsigned char, unsigned char);
 ...
 */
xinu_devcall telnetRead(device *devptr, void *buf, unsigned int len)
{
...
static void telnetSendOption(device *phw, unsigned char command, unsigned char option)
{
