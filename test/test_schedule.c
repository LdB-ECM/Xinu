...
static void t4(int times, unsigned char *testArray, int *shared)
{
    int i = 0;
...
{
    char str[50];
    unsigned char testArray[4 * TIMES];
    unsigned char expectedResults[4 * TIMES];
    int shared = 0;
