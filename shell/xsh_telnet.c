...
thread telnetRecv(unsigned short);
thread telnetSend(unsigned short);
static int echoNegotiation(int, int, unsigned short);
static void sendOption(unsigned short, unsigned char, unsigned char);
...
thread telnetRecv(unsigned short dev)
{
    int ch;
...
thread telnetSend(unsigned short dev)
{
    int ch;
...
static void sendOption(unsigned short dev, unsigned char command, unsigned char option)
{
