...
#define UNLIMITED_LENGTH (~(unsigned int)0)

static int scan_string(char *ptr, int type, unsigned int maxlen,
                       const unsigned char *stopchar_tab,
                       int (*getch) (int, int), int (*ungetch) (int, int),
                       int arg1, int arg2, bool *eofptr);

static int scan_number_or_string(void *ptr, unsigned char type, unsigned int maxlen,
...
static const unsigned char *build_stopchar_tab(const unsigned char *ufmt, unsigned char *stopchar_tab);
            ...
            int arg1, int arg2)
{
    ...
    void *ptr;
    int c;
    unsigned char stopchar_tab[256];

    /* Interpret the format string as unsigned to avoid bugs with comparisons.
     * */
    const unsigned char *ufmt = (const unsigned char*)fmt;
...
static int scan_string(char *ptr, int type, unsigned int maxlen, const unsigned char *stopchar_tab,
                       int (*getch) (int, int), int (*ungetch) (int, int),
                       int arg1, int arg2, bool *eofptr)
{
    unsigned int len;
