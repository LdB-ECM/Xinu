...
{
    int retval;
    unsigned int recvTimeout = 5000;  /* Milliseconds to wait before timing out a
                                 given receive (not the whole client)  */
    unsigned int delay = 1000;  /* Milliseconds to wait after non-timeout error */
    unsigned long starttime = clktime;
