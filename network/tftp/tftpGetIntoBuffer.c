...
static int tftpCopyIntoBufferCb(const unsigned char *data, unsigned int len, void *ctx);
...
struct tftpFileDataBlock
{
    ...
    unsigned char data[TFTP_FILE_DATA_BLOCK_SIZE - sizeof(unsigned long) - sizeof(void*)];
};
